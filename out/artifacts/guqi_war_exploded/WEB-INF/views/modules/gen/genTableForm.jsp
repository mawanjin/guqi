                    ...
                    <table id="contentTable" class="table table-hover">
                        ...
                        <c:forEach items="${genTable.columnList}" var="column" varStatus="vs">
                            <tr${column.delFlag eq '1'?' class="error" title="已删除的列，保存之后消失！"':''}>
                                ...
                                <td>
                                    <input type="text" name="columnList[${vs.index}].javaField" style="width: 100px"
                                           value="${column.javaField}" maxlength="200" class="required form-control"/>
                                </td>
                                <td>
                                ...
                                <td>
                                    <select name="columnList[${vs.index}].queryType" style="width: 35px" class="required form-control">
                                ...
                                <td>
                                    <input type="text" name="columnList[${vs.index}].sort" value="${column.sort}"
                                           maxlength="200" class="required form-control digits"/>
                                </td>
                            </tr>
                        </c:forEach>
                        </tbody>
